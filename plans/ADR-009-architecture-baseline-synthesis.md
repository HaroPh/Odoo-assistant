...
| R6 | **Quota Guard chưa build (A4)** | Thấp | Degrade-to-local tự động khi cloud lỗi/hết quota (hệ không chết) | Không cảnh báo chủ động 80%/95%; âm thầm chậm tới khi A4 xong |
