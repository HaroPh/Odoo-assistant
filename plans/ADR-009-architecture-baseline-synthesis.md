...
🔴 Phase 0 (Hardening-Verify) — MỚI, cổng bắt buộc, effort thấp (verify không build)
   ...
   Phase A (AI Layer hybrid)
     A1 alias gateway (0.5d) → A2 ROLE_MODELS + /no_think điều kiện (1–2d, gồm M4/S4)
        ...
        → A3 flip 3/7 role (Router/Eval/Chit-chat) sang cloud — **2/3 ĐÃ FLIP**
          (Router 2026-07-09 Task 6; Chit-chat 2026-07-09 sau khi có eval-gate
          riêng — xem R10). Evaluator CHƯA flip (gate FAIL, false_confirm=1).
